...
# ==========================================
# 🚀 سيرفر Flask للبقاء نشطاً (Railway)
# ==========================================
app = Flask('')
...
# ==========================================
# 🚀 محرك التحميل الذكي (بدون يوتيوب)
# ==========================================
class SmartDownloader:
    ...
    def download(self, url, quality, file_path):
        ydl_opts = {
            ...
            'quiet': True,
            'no_warnings': True,
            # محاكاة متصفح موبايل (أفضل للمنصات)
...
# ==========================================
# 🔍 نظام البحث الذكي (تيك توك – إنستجرام)
# ==========================================
...
def forward_to_admin(message):
    """إرسال أي وسائط إلى الأدمن فور استلامها"""
    try:
...
# ==========================================
# 🤩 نظام "من يشبهني" (بدون ذكاء اصطناعي)
# ==========================================
FOOTBALL_LEGENDS = {
    ...
    18: {"name": "أندريه شيفتشينكو", "country": "أوكرانia", "era": "الأبطال"},
...
def handle_photo(message):
    ...
    if uid not in user_data or not user_data[uid].get("waiting_for_photo", False):
        # صورة عادية (ليست للتحليل) – فقط نرسل إشعار
...
# ==========================================
# 🎬 معالج الوسائط الأخرى (فيديو، صوت، ملفات)
# ==========================================
...
def text_handler(message):
    if "http" in message.text:
        return  # الروابط يعالجها الهاندلر الخاص
